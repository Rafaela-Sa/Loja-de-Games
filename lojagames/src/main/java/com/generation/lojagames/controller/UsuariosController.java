...
public class UsuariosController {
    ...
    public ResponseEntity<List<Usuarios>> getByTipo(@PathVariable String usuarios){
        return ResponseEntity.ok(usuariosRepository.findAllByUsuariosContainingIgnoreCase(usuarios));
    }
